...
const struct weapon weapons[] = {
	WEAP(WP_COLT45, 1.75, RPM(200), RANGE(200), AMMO_45ACP, 100, WF_MUZZLEFLASH, WS_PISTOL),
	WEAP(WP_BROWNING, 1.75, RPM(200), RANGE(200), AMMO_45ACP, 110, WF_MUZZLEFLASH, WS_PISTOL),
	WEAP(WP_SA80, 3, RPM(800), RANGE(500), AMMO_556, 1400, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_GUN),
	WEAP(WP_MP5, 5, RPM(800), RANGE(200), AMMO_9MMPARABELLUM, 800, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_MACHINEGUN),
	WEAP(WP_UZI, 5, RPM(600), RANGE(200), AMMO_9MMPARABELLUM, 700, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_MACHINEGUN),
	WEAP(WP_STEYR, 4, RPM(650), RANGE(300), AMMO_556, 1500, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_GUN),
	WEAP(WP_AK47, 5, RPM(600), RANGE(400), AMMO_556, 800, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_GUN),
	WEAP(WP_M16A2, 4, RPM(600), RANGE(400), AMMO_556, 900, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_GUN),
	WEAP(WP_M203, 4, RPM(600), RANGE(400), AMMO_556, 1500, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_GUN),
	WEAP(WP_RPK, 4, RPM(600), RANGE(800), AMMO_762, 4900, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_GUN),
	WEAP(WP_L7A2, 6, RPM(850), RANGE(1200), AMMO_762, 5700, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_MACHINEGUN),
	WEAP(WP_HK21, 8, RPM(900), RANGE(1200), AMMO_762, 7800, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_MACHINEGUN),
	WEAP(WP_M60, 4, RPM(550), RANGE(1000), AMMO_762, 6200, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_GUN),
	WEAP(WP_MG42, 12, RPM(1200), RANGE(2000), AMMO_762, 7000, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_MACHINEGUN),
	WEAP(WP_M134, 10, RPM(3000), RANGE(2000), AMMO_10MM, 10400, WF_AUTOMATIC | WF_MUZZLEFLASH, WS_MACHINEGUN),
